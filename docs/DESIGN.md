...
> Design notes for **ecommerce-webhook-retry-queue-retry-webhook-ecommerce-typesc** — a runnable typescript example that Typed order webhook delivery with zod validation and queue retries.
...
- **Feature code** — the actual task: reliable-order-webhooks.
